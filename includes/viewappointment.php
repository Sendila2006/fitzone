...
<head>
    ...
    <title>View Appointments | FitZone</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body {
            background-image: url('/gym/pic/va.jpeg');
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if ($isLoggedIn): ?>
                        ...
                        <li class="nav-item"><a class="nav-link" href="cancel_appointment.php">Cancel Appointment</a></li>
...
<div class="container mt-5">
    ...
    <a href="cancel_appointment.php" class="btn btn-primary">Cancel Your Appointment</a>
