...
if (isset($_GET['delete'])) {
    ...
    header('Location: manage_admin_class.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_class'])) {
    ...
    $insert_sql = "INSERT INTO class_schedule (class_name, instructor_name, class_time) 
    ...
    // Redirect to reload the page and show message
    header('Location: manage_admin_class.php');
    exit();
}
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-custom" name="add_class">Add Class</button>
                    </form>
                </div>

                <!-- View and Manage Classes -->
                <h3>View and Manage Classes</h3>
